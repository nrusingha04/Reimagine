    ...
    <div className="space-y-4">
      ...
      >
        ...
        {showComparison && processedImage ? (
          ...
          >
            {/* Processed Image (Background, shows on right) */}
            ...
            {/* Original Image (Clipped, shows on left) */}
            <div
            ...
            {/* Slider */}
            <div
              className="absolute top-0 bottom-0 w-[2px] bg-gradient-primary"
              style={{
                left: `${sliderPosition}%`,
      ...
      <div className="text-center">
        {isProcessing ? (
          ...
          <p className="text-sm text-primary">
            ✨ Processing applied! Compare or export your result
          </p>
        ) : (
