      ...
      {uploadedImage ? (
        ...
        >
          ...
          >
            ...
            <span
              className={`inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 border border-card-border glass h-10 px-4 py-2 mt-2 hover:bg-accent hover:text-accent-foreground ${
                isUploading
                  ? "opacity-50 cursor-not-allowed pointer-events-none hover:bg-transparent hover:text-foreground"
                  : ""
              }`}
            >
              {isUploading ? (
